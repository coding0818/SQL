#Customer
insert into `Customer` values ('760121-1234567', '정우성', '서울', '1976-01-21', 'ws@naver.com', '010-1101-7601', '배우');
insert into `Customer` values ('750611-1234567', '이정재', '서울', '1975-06-11', 'jj@naver.com', '010-1102-7506', '배우');
...
insert into `Customer` values ('721128-1234567', '유재석', '부산', '1972-11-28', 'jaesuk@naver.com', '010-6101-7211', '개그맨');
insert into `Customer` values ('920907-1234567', '강호동', '부산', '1992-09-07', 'hodong@naver.com', '010-7103-9209', '개그맨');
insert into `Customer` values ('821209-1234567', '조인성', '광주', '1989-12-09', 'join@gmail.com', '010-7104-8912', '배우');
...
insert into `Cards` values ('1011-1001-1009', '821209-1234567', '101-11-1009', '2020-11-28', 1000000, '2020-12-10', 'check');
...
insert into `Accounts` values ('101-11-1009', '821209-1234567', '자유입출금', 1763000, 'Y', '2020-11-28', '조인성');
...
select 
`cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`
from `Customer` as a
join `Cards` as b
